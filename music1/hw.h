...
int sceAudio_driver_837701CC(int samplecount, int samplerate, int unk);//unk = 2 (only func called by sceAudioOutput2Reserve)
int sceAudio_driver_AC81DE4F(int vol, void *buf);//sceAudioOutput2OutputBlocking alias, present in 1.5
int sceAudio_driver_B7F5A1B2(void);//sceAudioOutput2Release alias, also present in 1.5
