...
function link() {
    echo "link ELF $1"
    psp-g++ -D_PSP_FW_VERSION=371 -L$DIR/lib -L$PSPSDK/lib -Wl,-q,-T$PSPSDK/lib/linkfile.prx -nostartfiles *.o $DIR/plugin.o -lpspkernel -lc -lpspsdk -lpspkernel -lc -lpspsdk -lpspkernel -lc -lpspsdk -lpspkernel -lc -lpspsdk -lpspkernel -lc -lpspsdk -o $1.elf || exit 1
