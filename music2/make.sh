...
psp-g++ -D_PSP_FW_VERSION=371 -L./lib -L/usr/local/pspdev/psp/sdk/lib -Wl,-q,-T/usr/local/pspdev/psp/sdk/lib/linkfile.prx -nostartfiles *.o -o -lpspkernel music2.elf
